...
def run_apidoc(_):
    ...
    better_apidoc.main(
        ['better-apidoc', '-t', './_templates', '--force', '--no-toc',
         '--separate', '-o', './API', '../src/trajectorydata'])
...
source_suffix = '.rst'
master_doc = 'index'
project = 'TrajectoryData'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = release = trajectorydata.__version__

pygments_style = 'sphinx'
extlinks = {
    'issue': ('https://github.com/goerz/trajectorydata/issues/%s', '#'),
    'pr': ('https://github.com/goerz/trajectorydata/pull/%s', 'PR #'),
}
